package com.leonardo.mingotti.cli;

import com.leonardo.mingotti.interfaces.CatalogRepository;
        ...
        while (true) {
            ...
            try {
                switch (cmd) {
                    ...
                    case "show" ->
                            cart.items().forEach(ci -> System.out.println(ci.getItem().getName() + " x" + ci.getQuantity() + " = " + ci.lineTotal()));
